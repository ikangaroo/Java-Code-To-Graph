...
public class outerClassMethod2Json extends Graph2Json {
    @Expose
    ...
    public outerClassMethod2Json(File pfile, String version, String methodName, HashMap<String, HashMap<MethodDeclaration, String>> CalledMethod, MethodDeclaration methodDeclaration) {
        //每个函数的处理
        this.fileName = pfile.getName();
        this.Version = version;
        this.CalledMethod = CalledMethod;//<文件名，调用的函数名>
        this.methodDeclaration = methodDeclaration;
        this.MethodName = FunctionClass.getClassOfMethod(methodDeclaration).concat("_")+methodName;//获得类名_函数名
